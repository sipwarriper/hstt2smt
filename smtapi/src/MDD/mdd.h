...
public:
	...
	pair<literal,MDD*> getSelectorAndChild(int idx) const;

	//Get all the selectors
	const vector<literal> & getSelectors() const;
	...
	//Ostream operator
	friend ostream & operator<<(ostream & s, const MDD & m);
