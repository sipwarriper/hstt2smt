...
bool GlucoseAPIEncoder::assertAndCheck(int lb, int ub, vector<literal> * assumptions){
...
Lit GlucoseAPIEncoder::getLiteral(const literal & l, const vector<Var> & vars){
	if(l.arith){
		cerr << "Error: Glucose cannot deal with arithmetic literals"<< endl;
