...
private:
	...
	vector<term_t> boolvars;
	vector<term_t> intvars;
	...
	term_t sumterm(const intsum & s, const vector<term_t> & intvars);

	//Returns the term_t representation of 'l'
	term_t getTerm(const literal & l, const vector<term_t> & boolvars, const vector<term_t> & intvars);
